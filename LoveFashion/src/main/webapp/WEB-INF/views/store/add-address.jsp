                        ...
                        <li class="fields">
                          ...
                          <div class="customer-name-middlename row">
                            <div class="field name-firstname col-md-6">
                              ...
                              <div class="input-box">
                                <form:input path="phone" title="Telephone" class="input-text required-entry" />
                                <div class="validation-advice">
                        ...
                        <li class="fields">
                          <div class="row">
                            <div class="field col-md-6">
                              ...
                              <div class="input-box">
                                <form:select path="regionId" class="validate-select jqtransformdone required-entry" id="region_id">
                            ...
                            <div class="field col-md-6">
                              ...
                              <div class="input-box">
                                <form:select path="countryId" class="validate-select jqtransformdone required-entry" defaultvalue="0" id="country_id">
