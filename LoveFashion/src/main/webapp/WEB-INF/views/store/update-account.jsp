                ...
                <div class="block block-account">
                  ...
                  <div class="block-content">
                    <ul>
                      ...
                      <li class="current"><strong><spring:message code="customer.dashboard.title.e9"></spring:message></strong></li>
              ...
              <div class="yt_main_inner">
                <div class="my-account">
                  <div class="page-title">
                    <h1><spring:message code="customer.update.title"></spring:message></h1>
                  </div>
                  ...
                  <form:form action="/customer/account/edit" method="post" id="form-validate" autocomplete="off" commandName="update">
                    <div class="row edit-account-form">
                      <div class="fieldset col-md-6">
                        <h2 class="legend"><spring:message code="customer.dashboard.title.e9"></spring:message></h2>
                        <ul class="form-list">
                          <li class="fields">
                            <div class="customer-name row">
                              ...
                              <div class="field name-lastname col-md-6">
                                <label for="lastame" class="required"><em>*</em><spring:message code="common.lastname"></spring:message></label>
                                <div class="input-box">
                          ...
                          <li class="control"><form:checkbox path="changePassword" onclick="setPasswordForm(this.checked)" title="Change Password" class="checkbox" /> <label
                            for="change_password"><spring:message code="common.password.change"></spring:message></label></li>
                        </ul>
                      </div>
                      <div class="fieldset col-md-6" <c:if test="${empty param.change || !param.change}">style = 'display: none;'</c:if>>
                        <h2 class="legend"><spring:message code="common.password.change"></spring:message></h2>
                        <ul class="form-list">
                          <li><label for="current_password" class="required"><em>*</em><spring:message code="common.password.current"></spring:message></label>
                            <div class="input-box">
                          ...
                          <li class="fields">
                            <div class="row">
                              <div class="field col-md-6">
                                <label for="password" class="required"><em>*</em><spring:message code="common.password.new"></spring:message></label>
                                <div class="input-box">
                              ...
                              <div class="field col-md-6">
                                <label for="confirmation" class="required"><em>*</em><spring:message code="common.password.new.confirm"></spring:message></label>
                                <div class="input-box">
                    ...
                    <div class="buttons-set">
                      ...
                      <button type="submit" title="Save" class="button">
                        <span><span><spring:message code="common.save"></spring:message></span></span>
                      </button>
                    </div>
                  </form:form>
                </div>
